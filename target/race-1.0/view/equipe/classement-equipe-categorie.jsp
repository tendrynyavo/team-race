                    ...
                    <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="mt-3">
                        ...
                        <div class="form-group">
                            <form method="get" action="equipe/classement-equipe-categorie.do">
                        ...
                        <table class="table select-table">
                          ...
                          <tbody>
                              ...
                              <tr style="background-color: <%=rank.getColor() %>;">
                                ...
                                <td><a href="equipe/classement-coureur-equipe.do?idEquipe=<%=rank.getId() %>&id=<%=request.getParameter("id") %>"><i class="bi bi-plus-lg"></i></a></td>
                              </tr>
                              <% } %>
                          </tbody>
                        </table>
